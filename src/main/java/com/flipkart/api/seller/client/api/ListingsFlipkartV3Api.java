...
public class ListingsFlipkartV3Api {
  private ApiClient apiClient;

  public ListingsFlipkartV3Api() {
    this(Configuration.getDefaultApiClient());
  }

  public ListingsFlipkartV3Api(ApiClient apiClient) {
   ...
   */
  public Map<String, ListingChangeResponse> createListings(Map<String, CreateListingRequest> body) throws ApiException {
    ...
    String localVarPath = "/listings/v3";
   ...
   */
  public Map<String, ListingChangeResponse> updateListings(Map<String, UpdateListingRequest> body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/listings/v3/update";
