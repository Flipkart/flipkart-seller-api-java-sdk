...
import com.flipkart.api.seller.client.auth.Authentication;
import com.flipkart.api.seller.client.auth.HttpBasicAuth;
import com.flipkart.api.seller.client.auth.ApiKeyAuth;
import com.flipkart.api.seller.client.auth.OAuth;


public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = UrlConfiguration.getAPIClient();
  ...
  public ApiClient() {
    ...
    authentications.put("Oauth2SelfAccess", new OAuth());
